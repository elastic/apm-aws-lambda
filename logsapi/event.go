...
// LogType represents the log streams that the Lambda Logs API
// provides for subscription
type LogType string

const (
	// Platform log stream records events and errors related to
	// invocations and extensions
	Platform LogType = "platform"
	// Function log stream records logs written by lambda function
	// to stderr or stdout
	Function LogType = "function"
	// Extension log stream records logs generated by extension
	Extension LogType = "extension"
)

// SubLogType represents the subtype for each log type that is
// received in the log messages
type SubLogType string

const (
	// PlatformRuntimeDone event is sent when lambda function is finished it's execution
	PlatformRuntimeDone SubLogType = "platform.runtimeDone"
