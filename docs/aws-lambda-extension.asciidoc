...
Once you've installed the extension, there's one last step to take. You'll need to install the correct language agent and wrap the Lambda function handler.
...
The Node.js agent will wrap your Lambda function handler automatically. You can also use the following syntax to manually wrap the handler.
