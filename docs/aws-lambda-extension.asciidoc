...
Finally, to have the the Node.js automatically wrap your Lambda function handler, just add the following environment variable.
...
You can also use the following syntax to manually wrap the handler.
