...
NOTE: The necessary environment variables depend on the APM agent being used. Follow the https://www.elastic.co/guide/en/apm/agent/nodejs/current/lambda.html[Node.js agent setup guide], https://www.elastic.co/guide/en/apm/agent/python/current/lambda-support.html#lambda-setup[Python agent setup guide] or https://www.elastic.co/guide/en/apm/agent/java/current/aws-lambda.html#aws-lambda-instrumenting[Java agent setup guide], respectively, for specific instructions on setting the environment variables.
...
See the https://www.elastic.co/guide/en/apm/agent/nodejs/current/lambda.html[Node.js agent setup guide] for detailed instructions on setting up the Node.js agent for AWS Lambda.
...
See the https://www.elastic.co/guide/en/apm/agent/python/current/lambda-support.html[Python agent setup guide] for detailed instructions on setting up the Python agent for AWS Lambda.
...
See the https://www.elastic.co/guide/en/apm/agent/java/current/aws-lambda.html[Java agent setup guide] for detailed instructions on setting up the Java agent for AWS Lambda.
